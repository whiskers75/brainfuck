...
function _step(pointer, data, cursor) {
    ...
    this._debugger.push(this.source.substr(0, this.cursor) + ' | ' + this.data);
    console.log(this.source.substr(0, this.cursor) + ' | ' + this.data);
...
var brainfuck = module.exports = {
    ...
    _debugger   : [],       // list of data from start to finish
